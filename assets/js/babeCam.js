...
(function(s) {
    ...
    function j(S) {
        ...
        for (var R = 0, U; U = T[R] && T[R].split("="); R++) {
...
WebcamToy.Effect = (function(k) {
    ...
    function t(K) {
        return K.replace(/[a-zA-Z]/g, function(L) {
...
WebcamToy.UI = (function(R) {
    var bY = {},
        ...
        a6, U = 0,
        v, a1, aP, g, aZ, ak, bk, J, bq, bA, V = 105,
        bv = false,
        aD = $("#toy"),
        b7 = $("#toy-intro"),
        b9 = $("#toy-ui"),
...
WebcamToy.Home = (function(e) {
    ...
    function m() {
        if (e.init && window.$) {
            ...
            if (t) {
                t.delay(50).fadeOut(250, function() {
                    setTimeout(function() {
                        if (q) {
                            if ($(window).height() > 600) {
                                s.addClass("no-cws").fadeIn(200, function() {
                                    s.removeAttr("style")
                                })
                            } else {
